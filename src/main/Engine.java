...
public class Engine {
	...
	public Engine(Map initMap, Player player1, Player player2, int timeout)
	{
		this.map = initMap;
	...
	{
		getMoves(player1.getBot().getPlaceArmiesMoves(this.timeout), player1);
		getMoves(player2.getBot().getPlaceArmiesMoves(this.timeout), player2);

		executePlaceArmies();

		getMoves(player1.getBot().getAttackTransferMoves(this.timeout), player1);
		getMoves(player2.getBot().getAttackTransferMoves(this.timeout), player2);
	...
	public void distributeStartingRegions()
	{
		...
		ArrayList<Region> p1Regions = parser.parsePreferredStartingRegions(player1.getBot().getPreferredStartingArmies(this.timeout, pickableRegions), pickableRegions, player1);
		ArrayList<Region> p2Regions = parser.parsePreferredStartingRegions(player2.getBot().getPreferredStartingArmies(this.timeout, pickableRegions), pickableRegions, player2);
